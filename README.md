...
```javascript
import { cumax, cumin, dcumax, dcumin, dmax, dmin, drange, dztest, dztest2, max, maxBy, min, minBy, range, scumax, scumin, smax, smin, srange, sztest, sztest2, ztest, ztest2 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ndarray@deno/mod.js';
```
