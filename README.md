...
```javascript
import { covarmtk, cumax, cumin, dcovarmtk, dcumax, dcumin, dmax, dmaxabs, dmaxsorted, dmean, dmin, dminabs, dnanmax, dnanmean, dnanmin, drange, dztest, dztest2, max, maxBy, maxabs, maxsorted, mean, min, minBy, minabs, nanmax, nanmean, nanmin, range, scovarmtk, scumax, scumin, smax, smaxabs, smaxsorted, smean, smin, sminabs, snanmax, snanmean, snanmin, srange, sztest, sztest2, ztest, ztest2 } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-ndarray@esm/index.mjs';
```
