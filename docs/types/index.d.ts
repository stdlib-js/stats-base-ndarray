...
interface Namespace {
	...
	*
	* @example
	* var Float64Results = require( '@stdlib/stats-base-ns.ztest-one-sample-results-float64' );
	* var resolveEnum = require( '@stdlib/stats-base-ns.ztest-alternative-resolve-enum' );
	* var structFactory = require( '@stdlib/array-struct-factory' );
	* var scalar2ndarray = require( '@stdlib/ndarray-from-scalar' );
	* var ndarray = require( '@stdlib/ndarray-ctor' );
	*
